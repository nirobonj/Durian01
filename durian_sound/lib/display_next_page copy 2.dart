...
class _DisplayNextPageState extends State<DisplayNextPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // switch (predict) {
    //   case 1:
    //     result = Predict(1, 'ดิบ 1', '1', '1', 'ดิบมากเนื้อสีครีม อ่อนๆ',
    //         'assets/image/ระดับ 1.png');
    //     break;
    //   case 2:
    //     result = Predict(2, 'ดิบ2', '2', '2', 'ดิบรองลงมา สีเริ่มเหลืองนิดๆ',
    ...
    //   default:
    //     result = Predict(
    //         0, 'ไม่ทราบระดับ', '0', '0', 'Unknown', 'assets/image/ระดับ 0.png');
    // }
  ...
  Widget _buildLevelWidget(String levelText, String detail, String imagePath) {
    return Expanded(
      child: Container(
        decoration: const BoxDecoration(
          color: Colors.white,
